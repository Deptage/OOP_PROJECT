...
public class Menu {
    ...
    public void showMenu() {
        ...
        switch (input) {
            case 1 -> this.createAMatrixMenu();
            case 2 -> this.deleteAMatrixMenu();
            case 3 -> this.displayMatrices();
            case 4 -> this.addMatrices();
            case 5 -> this.subtractMatrices();
            case 6 -> this.multiplyMatrices();
            case 7 -> this.transposeAMatrix();
            case 8 -> this.multiplyByANumber();
